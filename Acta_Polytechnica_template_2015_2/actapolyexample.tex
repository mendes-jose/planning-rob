...
planning the whole motion from initial to goal configurations is
...
the first approach may be prohibited high as planning complexity is most certainly dependent of the distance between start and goal configurations.
...
This approach is based in two concepts: planning horizon $T_p$ and update/computation horizon $T_c$.
All robots in the team use the same $T_p$ and $T_c$. $T_p$ is the timespan for which a solution will be computed and
