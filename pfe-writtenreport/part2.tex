...
\subsubsection{Robot-to-obstacle distance calculation for the convex polygon representation}
...
\todo[inline]{some code is available on the internet, Google code written in D language and/or the other one on stackverflow, see bookmarks}
