...
\section{Constraints and cost functions}
...
%    must be respect by the robots $R_b$ and $R_b$:
    ...
    $R_b$. %TODO explain the calcul of this set
...
This two step scheme is explained in details in~\cite{Defoort2009, Defoort2007a} where the 
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tikzpicture}
		\matrix (m)[matrix of nodes, column  sep=1cm,row  sep=8mm, align=center, nodes={rectangle,draw, anchor=center} ]{
		    ...
		    |[desicion]| {Is $\mathcal{C}_{b,com}(\tau_k) \bigcup \mathcal{C}_{b,coll}(\tau_k)$ empty?} &  &|[desicion]| {Is $\mathcal{C}_{b,com}(\tau_k) \bigcup \mathcal{C}_{b,coll}(\tau_k)$ empty?}  \\
		    |[block]| {Sync with $\forall R_c | R_c \in \mathcal{C}_{b,com} \bigcup \mathcal{C}_{b,coll}$}& &  |[block]| {Computation of conflict sets} \\
		...
		\end{tikzpicture}
		\end{adjustbox}
    \caption{Flowchart illustrating the distributed local motion planning}
\end{figure}
...
\begin{figure}[!h]\centering
  \includegraphics[width=.45\linewidth]{./images/collision/new/multirobot-path.pdf} %
  %\rule{5cm}{5cm} % <-- this is just a black box substitute for graphics
  \\[1mm]
  \includegraphics[width=.45\linewidth]{./images/collision/new/multirobot-vw.pdf} % 
  %\rule{5cm}{5cm} % <-- this is just a black box substitute for graphics
  \includegraphics[width=.45\linewidth]{./images/collision/new/multirobot-interr.pdf} % 
  %\rule{5cm}{5cm} % <-- this is just a black box substitute for graphics
...
\begin{figure}[!h]\centering
  \includegraphics[width=.45\linewidth]{./images/drho/drho-rmp.pdf} % <-- use this
  %\rule{5cm}{5cm} % <-- this is just a black box substitute for graphics
...
increases.
\begin{figure}[!h]\centering
  \includegraphics[width=.45\linewidth]{./images/penetration/pen-nsi.pdf} %
  %\rule{5cm}{5cm} % <-- this is just a black box substitute for graphics
