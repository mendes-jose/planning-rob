...
#					if False:
					if discriminant > 0: # then theirs paths cross at some point
						...
						forbiddenSpaceRadius = self.rho # TODO other robot radius
						...
						forbiddenSpace.append(RoundObstacle([forbiddenSpaceCentroid[0,0], forbiddenSpaceCentroid[1,0]], forbiddenSpaceRadius))
						forbiddenSpaceIdx.append(len(forbiddenSpace)-1)
