...
ax2.set_title(r'$MCT/T_c$ and detection radius relationship')
...
ax.grid()
ax2.grid()
ax.set_ylabel(r'$T_{tot}\ (s)$')
ax2.set_ylabel(r'$MCT/T_c$')
ax.set_xlabel(r'$d_{b,sen} (m)$')
ax2.set_xlabel(r'$d_{b,sen} (m)$')
ax.set_title(r'Total execution time and detection radius relationship')
